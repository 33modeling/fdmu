...
%% From a Sealed Two-Signal Profile to Prediction and Protection
%%
...
%%   sections/generated evidence-rendered table bodies and result macros
%%   figures/*.tex      one file per figure (TikZ), input by sections
%%   tables/*.tex       stable include wrappers plus hand-authored appendix tables
%%   references.bib     bibliography
%%
%% The paper asks whether a pre-unlearning two-signal profile predicts
...
\providecommand{\PredictionHeadline}{\resph{Prediction-score correlation, gains over both
signal endpoints, uncertainty, and the strongest reversal.}}
\providecommand{\FidelityHeadline}{\resph{Frozen Loss Susceptibility operating point;
rank fidelity to the direct-gradient reference on
declared setting-level support, top-$K_{\mathrm{fid}}$ overlap, time, memory,
and integrity coverage.}}
\providecommand{\ProtectionHeadline}{\resph{Protection effects, no-repair
net benefit, feasibility slack, and the strongest failure mode.}}
\providecommand{\TransferHeadline}{\resph{Coverage across models, benchmarks,
requests, and parents, together with observed failure boundaries.}}
\providecommand{\ConclusionHeadline}{\resph{Strongest prediction, Loss
Susceptibility fidelity, protection, and failure-boundary result.}}
...
collateral damage, retained-behavior risk, Loss Susceptibility,
